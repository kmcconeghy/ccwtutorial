...
1. [Survival Analysis](surv_00_summ.qmd): Background for statistical analysis
2. [Cloning-Censoring-Weighting](ccw_00_summ.qmd): Primary section which conducts an in-depth CCW analysis with detailed explanations.
3. [Appendix](app_00_summ.qmd): Additional sections describing data, computation and some related methods.
